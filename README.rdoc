...
By no means did we write this code.  This is a fork from [https://github.com/wijet/taps](wijet/taps) which is in turn a fork of [https://github.com/ricardochimal/taps](ricardochimal/taps).  Both repos are no longer maintained.  Feel free to make any pull-requests and I'll try to keep this up to date.
